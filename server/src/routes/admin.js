...
const PLAN_PRICES = { free: 0, starter: 19, pro: 49, enterprise: 199 };
...
router.get("/stats", async (_req, res) => {
  ...
  const planBreakdown = await many(
...
router.put("/subscriptions/:businessId", async (req, res) => {
